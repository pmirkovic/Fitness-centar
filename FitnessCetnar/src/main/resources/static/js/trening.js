    ...
    $.ajax({
        ...
        success: function (response) {                              // ova f-ja se izvršava posle uspešnog zahteva
            ...
            for (let trening of response) {                        // prolazimo kroz listu svih zaposlenih
                ...
                let btn = "<button class='btnSeeMore' data-id=" + trening.id + ">See More</button>";
                row += "<td>" + btn + "</td>";                      // ubacujemo button u poslednju ćeliju reda
                btn = "<button class='btnDelete' data-id=" + trening.id + ">Delete</button>";
                row += "<td>" + btn + "</td>";
                row += "</tr>";                                     // završavamo kreiranje reda

                $('#trening').append(row);                        // ubacujemo kreirani red u tabelu čiji je id = employees
            }
        },
